      ...
      <div className="leading-none flex items-center">
        ...
        <div className="flex justify-between lg:w-full items-center">
          ...
          <div>
            <Link
              to={`/editReview/${_id}`}
              className="flex mb-3 btn btn-sm btn-outline btn-ghost text-white"
            >
              <AiTwotoneEdit></AiTwotoneEdit>Edit
            </Link>
            <Link
              onClick={handleDeleteReview}
              className="flex btn btn-sm btn-outline btn-ghost text-white"
            >
